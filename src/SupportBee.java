...
public class SupportBee {
	...
	private String request(String url, String... params) {
		...
		url = this.url + "/tickets.json?auth_token=" + this.auth_token
				+ "&per_page=" + per_page + "&page=" + page + "&label=" + label;
		return GET_Request(url);

	}

	private String request_search_tickets(String url, String query,
			String per_page, String page, String spam, String trash) {
		url = this.url + "/tickets/search.json?auth_token=" + this.auth_token
	...
	private String request_create_ticket(String url, String subject,
		...
		// notify_requester + "&content=" + content;
		String url_params = create_json(subject, requester_name,
	...
	private String request_show_tickets(String id) {
		url = this.url + "/tickets/" + id + ".json" + "?auth_token="
				+ this.auth_token;
		System.out.println(url);
		return GET_Request(url);
	}
	...
	private String request_archive_ticket(String id) {
		url = this.url + "/tickets/" + id + "/archive.json" + "?auth_token="
				+ this.auth_token;
	...
	private String request_star_ticket(String id) {
		url = this.url + "/tickets/" + id + "/star.json" + "?auth_token="
				+ this.auth_token;
		String url_params = id;
		return POST_Request(url, url_params);
	}
	...
	private String request_spam_ticket(String id) {
		url = this.url + "/tickets/" + id + "/spam.json" + "?auth_token="
				+ this.auth_token;
		String url_params = id;
		return POST_Request(url, url_params);
	}
	...
	private String request_trash_ticket(String id) {
		url = this.url + "/tickets/" + id + "/trash.json" + "?auth_token="
				+ this.auth_token;
		String url_params = id;
		return POST_Request(url, url_params);
	}
	...
	private String request_fetch_reply_ticket(String id) {
		url = this.url + "/tickets/" + id + "/replies.json" + "?auth_token="
				+ this.auth_token;
		// String url_params = id;
		return GET_Request(url);
	}
	...
	private String request_show_reply_ticket(String ticket_id, String id) {
		url = this.url + "/tickets/" + ticket_id + "/replies/" + id + ".json"
	...
	private String request_fetch_comment_ticket(String id) {
		url = this.url + "/tickets/" + id + "/comments.json" + "?auth_token="
				+ this.auth_token;
		// String url_params = id;
		return GET_Request(url);
	}
	...
	private String request_fetch_agents(boolean with_invited) {
		url = this.url + "/users.json" + "?auth_token=" + this.auth_token
				+ "?with_invited=" + with_invited;
		return GET_Request(url);
	}

	private String request_show_users(String id) {
		url = this.url + "/users/" + id + ".json" + "?auth_token="
				+ this.auth_token;
		return GET_Request(url);
	}
	...
	private String request_add_labels(String ticket_id, String label) {
		url = this.url + "/tickets" + ticket_id + "/labels/" + label + ".json"
				+ "?auth_token=" + this.auth_token;
	...
	public String search_tickets(String query, String per_page, String page,
			String spam, String trash) {
		String data = request_search_tickets(this.url, query, per_page, page,
				spam, trash);
		return data;
	}

	public String search_tickets(String query) {
		String data = request_search_tickets(this.url, query, "15", "1",
				"false", "false");
		return data;
	}
	...
	/*
	 * public String add_labels(String ticket_id, String label){ String data =
	 * request_add_labels(ticket_id, label); return data; }
	 * 
	 * public String remove_labels(String ticket_id, String label){ String data
	 * = request_remove_labels(ticket_id, label); return data; }
	 */
